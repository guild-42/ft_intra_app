...
class $IntraNotificationsTable extends IntraNotifications
  ...
  VerificationContext validateIntegrity(
    Insertable<IntraNotification> instance, {
...
class IntraNotification extends DataClass
  ...
  factory IntraNotification.fromJson(
...
class $CookieStoreTable extends CookieStore
  ...
  static const VerificationMeta _providedAtMeta = const VerificationMeta(
    'providedAt',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CookieStoreData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('provided_at')) {
      context.handle(
        _providedAtMeta,
        providedAt.isAcceptableOrUnknown(data['provided_at']!, _providedAtMeta),
      );
    }
  ...
  CookieStoreData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CookieStoreData(
      ...
      providedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}provided_at'],
      )!,
...
class CookieStoreData extends DataClass implements Insertable<CookieStoreData> {
  ...
  factory CookieStoreData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CookieStoreData copyWithCompanion(CookieStoreCompanion data) {
    return CookieStoreData(
      ...
      providedAt: data.providedAt.present
          ? data.providedAt.value
          : this.providedAt,
...
class $FriendsTable extends Friends with TableInfo<$FriendsTable, Friend> {
  ...
  static const VerificationMeta _blackholedAtMeta = const VerificationMeta(
    'blackholedAt',
  );
  @override
  ...
  static const VerificationMeta _discordDmUrlMeta = const VerificationMeta(
    'discordDmUrl',
  );
  @override
  ...
  static const VerificationMeta _lastSeenLocationMeta = const VerificationMeta(
    'lastSeenLocation',
  );
  @override
  ...
  Friend map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Friend(
      ...
      blackholedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}blackholed_at'],
      ),
      discordDmUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}discord_dm_url'],
      ),
      ...
      lastSeenLocation: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}last_seen_location'],
      ),
...
class Friend extends DataClass implements Insertable<Friend> {
  ...
  Friend copyWith({
    ...
    blackholedAt: blackholedAt.present ? blackholedAt.value : this.blackholedAt,
    discordDmUrl: discordDmUrl.present ? discordDmUrl.value : this.discordDmUrl,
...
class $$IntraNotificationsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$IntraNotificationsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CookieStoreTableCreateCompanionBuilder =
    CookieStoreCompanion Function({
      Value<int> id,
      required String cookie,
      Value<DateTime> providedAt,
      Value<DateTime?> expiresAt,
...
typedef $$CookieStoreTableUpdateCompanionBuilder =
    CookieStoreCompanion Function({
      Value<int> id,
      Value<String> cookie,
      Value<DateTime> providedAt,
...
class $$CookieStoreTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CookieStoreTable,
...
typedef $$CookieStoreTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CookieStoreTable,
      CookieStoreData,
