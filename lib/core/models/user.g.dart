...
_$FtUserImpl _$$FtUserImplFromJson(Map<String, dynamic> json) => _$FtUserImpl(
...
Map<String, dynamic> _$$FtUserImplToJson(_$FtUserImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$FtUserImageImpl _$$FtUserImageImplFromJson(Map<String, dynamic> json) =>
    _$FtUserImageImpl(
...
Map<String, dynamic> _$$FtUserImageImplToJson(_$FtUserImageImpl instance) =>
    <String, dynamic>{
      'link': instance.link,
      'versions': instance.versions,
    };

_$FtImageVersionsImpl _$$FtImageVersionsImplFromJson(
        Map<String, dynamic> json) =>
    _$FtImageVersionsImpl(
...
Map<String, dynamic> _$$FtImageVersionsImplToJson(
        _$FtImageVersionsImpl instance) =>
    <String, dynamic>{
...
_$CursusInfoImpl _$$CursusInfoImplFromJson(Map<String, dynamic> json) =>
    _$CursusInfoImpl(
      id: (json['id'] as num).toInt(),
...
Map<String, dynamic> _$$CursusInfoImplToJson(_$CursusInfoImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'slug': instance.slug,
...
_$ProjectUserImpl _$$ProjectUserImplFromJson(Map<String, dynamic> json) =>
    _$ProjectUserImpl(
      id: (json['id'] as num).toInt(),
...
Map<String, dynamic> _$$ProjectUserImplToJson(_$ProjectUserImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
