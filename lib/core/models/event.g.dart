...
_FtEvent _$FtEventFromJson(Map<String, dynamic> json) => _FtEvent(
  ...
  campusIds:
      (json['campus_ids'] as List<dynamic>?)
...
Map<String, dynamic> _$FtEventToJson(_FtEvent instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
